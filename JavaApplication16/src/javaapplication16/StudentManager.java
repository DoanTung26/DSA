...
public class StudentManager {
    ...
    private static void initializeStudents() {
        students.add(new Student("Doan Tung", "tungddbh01121@fpt.com", 10.00));
        students.add(new Student("Tung", "tung123@gmail.com", 7.5));
        students.add(new Student("Quinn", "quinn@gmail.com", 4.0));
        students.add(new Student("Mai Linh", "linh@gmail.com", 1.0));
    }
    ...
    private static void displayAllStudents() {
        if (students.isEmpty()) {
            ...
            for (Student student : students) {
                System.out.println(student);
                System.out.println("Rank: " + getStudentRank(student.score));
            }
        }
    }
    ...
    private static void compareStudentsScores() {
        ...
        if (student1 == null || student2 == null) {
            ...
            if (student1.score > student2.score) {
                ...
                System.out.println(student1.name + "'s score: " + student1.score + " (" + getStudentRank(student1.score) + ")");
                System.out.println(student2.name + "'s score: " + student2.score + " (" + getStudentRank(student2.score) + ")");
    ...
    private static String getStudentRank(double score) {
